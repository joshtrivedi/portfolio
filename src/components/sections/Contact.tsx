  ...
  return (
    <section
      ...
      style={{
        padding: '6rem 0',
        position: 'relative',
        background: 'linear-gradient(180deg, transparent, rgba(var(--accent-rgb),0.03))',
      }}
    >
      <div
        style={{
        ...
        >
          {contactLinks.map((link) => (
            ...
            >
              ...
              <div>
                <p style={{ color: 'var(--text-muted)', fontSize: '0.72rem', fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase', marginBottom: 2 }}>
                  {link.label}
                </p>
